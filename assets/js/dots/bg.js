(function () {
    ...
    function initHeader() {
        ...
        target = { x: width / 2, y: height / 2 }; //where to draw init
    ...
    function shiftPoint(p) {
        TweenLite.to(p, 1 + 5 * Math.random(), {
            ...
            y: p.originY - 50 + Math.random() * 100, ease: Power4.easeInOut,
            onComplete: function () {
                shiftPoint(p);
            }
        });
    ...
    function Circle(pos, rad, color) {
        ...
        this.draw = function () {
            ...
            //ctx.fillStyle = 'rgba(255,0,102,' + _this.active + ')';
            ctx.fillStyle = 'rgba(0,0,0,0)'; //no dots
